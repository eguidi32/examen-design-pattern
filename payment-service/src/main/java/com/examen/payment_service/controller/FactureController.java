...
import com.examen.payment_service.dto.request.FacturesByReferencesRequest;
...
public class FactureController {
	...
	public List<FactureResponse> getFacturesByReferences(
			@Valid @RequestBody FacturesByReferencesRequest request) {
		return factureService.findFacturesByReferences(request.getReferences());
	}
